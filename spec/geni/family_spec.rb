    ...
    @client.oauth_client.connection.build do |b|
      b.adapter :test do |stub|
        ...
        stub.get('/api/profile-90990739?access_token=FAKE_OAUTH_TOKEN') do |env|
          [200, {}, get_mocked_response("https://www.geni.com/api/profile-90990739?access_token=#{token}")]
        end
        
        # Immediate family
        stub.get('/api/profile-90990739/immediate-family?access_token=FAKE_OAUTH_TOKEN') do |env|
          [200, {}, get_mocked_response("https://www.geni.com/api/profile-90990739/immediate-family?access_token=#{token}")]
        end
        
        # Parents
        stub.get('/api/profile-90990897,90990889?access_token=FAKE_OAUTH_TOKEN') do
          [200, {}, get_mocked_response("https://www.geni.com/api/profile-90990897,90990889?access_token=#{token}")]
        end
        
        # Partners
        stub.get('/api/profile-90990730?access_token=FAKE_OAUTH_TOKEN') do
          [200, {}, get_mocked_response("https://www.geni.com/api/profile-90990730?access_token=#{token}")]
        end
        
        # Children
        stub.get('/api/profile-90990832,90990843,90990667?access_token=FAKE_OAUTH_TOKEN') do
          [200, {}, get_mocked_response("https://www.geni.com/api/profile-90990832,90990843,90990667?access_token=#{token}")]
        end
        
        # Siblings
        stub.get('/api/profile-90990985,90990977,90990923,90990957?access_token=FAKE_OAUTH_TOKEN') do
          [200, {}, get_mocked_response("https://www.geni.com/api/profile-90990985,90990977,90990923,90990957?access_token=#{token}")]
        end
      end
    end
  end
